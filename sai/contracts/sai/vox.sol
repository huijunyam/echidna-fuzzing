...
contract SaiVox is DSThing {
    uint256  _par; //get the accrued holder fee (ref per sai)
    uint256  _way; //get the holder fee (interest rate)

    uint256  public  fix; //get the gem per sai settlement price
    uint256  public  how;
    uint256  public  tau; //get the time of last prod
